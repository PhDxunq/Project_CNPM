package com.example.phongvanrestaurant.components.Staff.Table;
...
public class StaffOrderSelectTableController {
    @FXML
    ...
    private void loadMenuView(int tableId, javafx.scene.input.MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Staff/menu-view.fxml"));
            Parent menuView = loader.load();

            MenuController menuController = loader.getController();
            menuController.setTableId(tableId);
            menuController.setStaffId(staffId);
    ...
    private void showUnpaidTableAlert(javafx.scene.input.MouseEvent event) {
        AlertExample alert = new AlertExample();
        alert.showAlert("Bàn chưa thanh toán","Hãy báo với thu ngân để thanh toán cho bàn!");
    }
    ...
    public void changeOrdersView(ActionEvent event) throws IOException {
        ...
        StaffOrdersController controller = new StaffOrdersController();
