package com.example.phongvanrestaurant.components.Staff.Menu;
...
public class MenuController {
    ...
    public void goBack(ActionEvent event) {
        try {
            Parent tableView = FXMLLoader.load(getClass().getResource("/com/example/phongvanrestaurant/Staff/staff-order-select-table-view.fxml"));
            ...
            e.printStackTrace();
            System.err.println("Error loading Table View FXML file.");
        }
    }
}
