...
import com.example.phongvanrestaurant.components.Cashier.Table.CashierBillController;
...
public class AdminTableController {
    ...
    private void loadMenuView(int tableId, javafx.scene.input.MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Admin/admin-menu-view.fxml"));
            Parent menuView = loader.load();

            AdminMenu menuController = loader.getController();
    ...
    private void showUnpaidTableAlert(int tableId, javafx.scene.input.MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Admin/admin-bill.fxml"));
