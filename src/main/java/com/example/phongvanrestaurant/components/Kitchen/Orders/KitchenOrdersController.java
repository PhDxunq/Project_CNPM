package com.example.phongvanrestaurant.components.Kitchen.Orders;

import com.example.phongvanrestaurant.components.AlertExample;
import com.example.phongvanrestaurant.components.Kitchen.Orders.OrderDetails.KitchenOrderDetailsController;
...
public class KitchenOrdersController implements Initializable {
    ...
    public void showDetails(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Kitchen/kitchen-order-details.fxml"));
            AnchorPane pane = loader.load();
            KitchenOrderDetailsController controller = loader.getController();
