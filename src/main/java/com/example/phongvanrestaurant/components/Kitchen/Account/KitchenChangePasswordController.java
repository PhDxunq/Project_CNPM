package com.example.phongvanrestaurant.components.Kitchen.Account;
...
public class KitchenChangePasswordController implements Initializable, StaffIdReceiver {
    private int staffId;
