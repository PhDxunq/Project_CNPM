...
public class KitchenLoginSucess {
    ...
    void onContinueButtonClicked(ActionEvent actionEvent) {
        try {
            ...
            if (rowsAffected > 0) {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Kitchen/kitchen-home.fxml"));
                Scene scene = new Scene(loader.load());
                KitchenHome controller = loader.getController();
