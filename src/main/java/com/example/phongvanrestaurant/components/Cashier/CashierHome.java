...
public class CashierHome implements Initializable {
    ...
    public void Home(ActionEvent event) {
        loadPage("cashier-banner");
    }

    @FXML
    public void Inventory(ActionEvent event) {
        loadPage("cashier-inventory");
    }

    @FXML
    public void Table(ActionEvent event) {
        loadPage("cashier-table");
    }

    @FXML
    public void ChangePassword(ActionEvent event) {
        loadPage("cashier-change-password");
    }
    ...
    private void loadPage(String page) {
        Parent root = null;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/phongvanrestaurant/Cashier/" + page + ".fxml"));
            root = loader.load();
