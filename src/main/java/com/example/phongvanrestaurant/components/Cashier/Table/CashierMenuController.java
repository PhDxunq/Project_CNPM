...
import com.example.phongvanrestaurant.components.Cashier.CashierHome;
...
public class CashierMenuController {
    ...
    public void goBack(ActionEvent event) {
        try {
            ...
            CashierHome cashierHomeController = loader.getController();
            cashierHomeController.Table(event);
            currentStage.show();
