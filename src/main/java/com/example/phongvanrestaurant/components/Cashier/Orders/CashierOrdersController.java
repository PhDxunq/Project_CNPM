package com.example.phongvanrestaurant.components.Cashier.Orders;
...
public class CashierOrdersController implements Initializable {
        ...
        confirmationAlert.showAndWait().ifPresent(response -> {
            if (response == confirmButton) {
                try {
                    ...
                    e.printStackTrace();
                    AlertExample alert = new AlertExample();
                    alert.showAlert("Lỗi","Đã xảy ra lỗi khi cập nhật đơn hàng. Vui lòng thử lại.");
                }
            } else {
