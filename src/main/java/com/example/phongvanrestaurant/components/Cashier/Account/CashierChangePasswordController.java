package com.example.phongvanrestaurant.components.Cashier.Account;
...
public class CashierChangePasswordController implements Initializable, StaffIdReceiver {
    private int staffId;
